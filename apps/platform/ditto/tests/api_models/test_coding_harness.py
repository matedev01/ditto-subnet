...
def test_platform_and_validator_harness_contracts_are_exact_mirrors() -> None:
    root = Path(__file__).resolve().parents[5]
    validator = root / "ditto/api_models/coding_harness.py"
    platform = root / "apps/platform/ditto/api_models/coding_harness.py"
