...
from ditto.api_models.coding import CodingModelEvidence
...
def test_platform_inference_contract_module_matches_validator_byte_for_byte() -> None:
...
def test_normalized_responses_receipts_and_evidence_match_vectors() -> None:
    ...
    CodingModelEvidence.model_validate_json(not_invoked.model_dump_json())
    ...
    for name in ("complete", "retry_complete", "provider_failure", "response_invalid"):
        ...
        CodingModelEvidence.model_validate_json(derived.model_dump_json())
        assert (
